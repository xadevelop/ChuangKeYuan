...
public class ParentsActivity extends Activity implements View.OnClickListener {
    ...
    private void initListView() {
        ...
        mListView = (ListView) findViewById(R.id.lv_parents);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                startActivity(new Intent(ParentsActivity.this,FirstParentsActivity.class));
            }
        });
    }
    //添加一个得到数据的方法，方便使用
    ...
    private class ListViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = mInflater.inflate(R.layout.activity_parents_listview, null);
                //得到各个控件的对象
                holder.image = (ImageView) convertView.findViewById(R.id.iv_parents_listview);
                holder.title = (TextView) convertView.findViewById(R.id.tv_parents_listview);
                //绑定ViewHolder对象
